    ...
    <div class="card-columns espaco-card">
      <div class="card">
        ...
        <div class="card-body">
          ...
          <p class="card-text">Muito mais do que uma simples ferramenta de monitoramento, o Torabit é uma plataforma de
            aferição de presença digital, análise de sentimento, comparação com a concorrência e suporte para
            mobilização nas redes.<br>
            Ao processar grandes quantidades de dados, compor gráficos, elaborar planilhas, emitir relatórios, fazer
            comparações entre marcas, produtos e nomes, o Torabit permite análises em profundidade do comportamento dos
            internautas em relação a qualquer assunto, nome, instituição ou empresa – e de forma rápida e intuitiva.</p>
        </div>
      </div>
      <div class="card p-3">
        <blockquote class="blockquote mb-0 card-body">
          <p>Ao processar grandes quantidades de dados, compor gráficos, elaborar planilhas, emitir relatórios, fazer
            comparações entre marcas, produtos e nomes, o Torabit permite análises em profundidade do comportamento dos
            internautas em relação a qualquer assunto, nome, instituição ou empresa – e de forma rápida e intuitiva.</p>
      ...
      <div class="card bg-primary text-white text-center p-3">
        <blockquote class="blockquote mb-0">
          <p>O Torabit também permite que seus usuários montem seus próprios índices comparativos – não importa o
            tamanho de seu negócio nem se se trata de pessoa física ou jurídica – para medir, monitorar e comparar
            qualquer segmento com presença nas redes sociais (Facebook, Twitter, Instagram, YouTube, Pinterest, Medium,
            Spotify, LinkedIn e Reclame Aqui.) e na
            internet em geral.
            Isso possibilita aos clientes comparar seus desempenhos com seus concorrentes ou parceiros. Os cálculos
            levam em conta o engajamento do usuário com cada marca (ou nome ou instituição) confrontado com a totalidade
            da audiência da marca em cada canal das mídias sociais.</p>
      ...
      <div class="card text-center">
        <div class="card-body">
          ...
          <p class="card-text">No Torabit você tem dois tipos de visualizações dos resultados dos stories do Instagram. Entregamos não só o desempenho dos stories, com total de repercussão, como também o ranking que mostra os melhores stories da sua marca.
</p>
          <p class="card-text"><small class="text-muted">Last updated 3 mins ago</small></p>
        </div>
      </div>
